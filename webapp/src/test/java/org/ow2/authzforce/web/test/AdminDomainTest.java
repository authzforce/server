...
public class AdminDomainTest extends RestServiceTest
{
	...
	{
		final JAXBElement<PolicySet> jaxbElement = testDomainHelper.unmarshal(new File(RestServiceTest.XACML_SAMPLES_DIR, "admin/policy.xml"), PolicySet.class);
	...
	public void requestPDP(final File testDirectory) throws JAXBException
	{
