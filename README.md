...
## License
This project is licensed under the terms of GPL v3 except for one Java class ([JettisonReader.java](webapp/src/main/java/org/ow2/authzforce/webapp/org/apache/cxf/jaxrs/provider/json/utils/JettisonReader.java) is under Apache License).
